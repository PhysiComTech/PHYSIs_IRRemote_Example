package com.physicomtech.kit.physis_irremote_app;
...
public class ControlActivity extends PHYSIsMQTTActivity {
    ...
    public static final String PUB_TOPIC = "IRREMOTE";                // Publish Topic
    public static final String SEND_IR = "1";                       // Publish Message

    Button btnConnect, btnDisconnect, btnSendIR;                    // 액티비티 위젯
    ...
    private void initWidget() {
        ...
        btnSendIR = findViewById(R.id.btn_send);
    ...
    private void setEventListener() {
        ...
        btnSendIR.setOnClickListener(new View.OnClickListener() {                   // IR 전송 버튼
            @Override
            public void onClick(View v) {
                publish(SERIAL_NUMBER, PUB_TOPIC, SEND_IR);     // IR 전송 메시지 Publish
            }
        });
    }
